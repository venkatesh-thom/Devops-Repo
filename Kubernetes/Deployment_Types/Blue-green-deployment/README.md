...
> ✅ Please open a Inbound rule in  any one of Worker Node  Security group and add  Custom TCP TCP 30001 .
...
```bash
http://<WorkerNode_Public_Ip>:30001
```

> To see live pods : watch kubectl get pods -n namespace
